  <script>
    ...
    window.pageVersion = '<?= isset($data["page_version"]) ? $data["page_version"] : "1"; ?>';
  ...
  <script src="Assets/archivosprincipal/js/footer.js?v=<?= isset($data['page_version']) ? $data['page_version'] : '1'; ?>" defer></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
  <script src="Assets/archivosprincipal/js/galeria.js?v=<?= isset($data['page_version']) ? $data['page_version'] : '1'; ?>" defer></script>
  <script src="Assets/archivosprincipal/js/timeline.js?v=<?= isset($data['page_version']) ? $data['page_version'] : '1'; ?>" defer></script>
  </body>
