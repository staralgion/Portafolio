...
(function ($) {
    ...
    function updateThemeSetting(id) {
        if ($("#light-mode-switch").prop("checked") == true || id === "light-mode-switch") {
            ...
            $("#app-style-black").attr('href', 'Assets/css/light.css');
            ...
            $("#app-style-black").attr('href', 'Assets/css/dark.css');
            sessionStorage.setItem("is_visited", "dark-mode-switch");
    ...
    function init() {
        ...
        initPreloader();
        Waves.init();
          // Recuperar la configuración del tema desde la cookie
...
function handleRequestResult(request) {
    if (request.readyState != 4 || request.status != 200) {
         Swal.fire("Error", "Acceso denegado", "error").then((result) => {
...
//     // Configura Select2 en los elementos con data-toggle="select"
//     $('[data-toggle="select"]').select2({
//         theme: 'default', // Cambia al tema predeterminado
